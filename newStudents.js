...
firebase.auth().onAuthStateChanged(async function(user) {
    if (user) {
      ...
      <div class="flex items-center mx-4 my-1 bg-white">
      ...
      if (students.length>0) {
        ...
        <div class="sm:flex items-center text-green-500 px-1 mx-4 py-1">
          <div class="sm:w-3/4 mr-2 mb-2"><strong class="text-gray-600">${user.displayName}</strong>, these are the newly registered students that have not been assigned: </div>
...
async function printStudent(student) {
  ...
  <div class = "sm:flex text-gray-500 border-2 border-green-500 mt-2 mb-2 px-4 mx-4 py-2 rounded items-center">
