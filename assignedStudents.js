...
function printBlank() {
    ...
    <div class = "sm:flex text-gray-500 border-2 border-green-500 mt-4 px-4 mx-4 pt-10 pb-6 rounded">
      <div class="w-full text-center text-3xl">  
        ...
        <div class="text-lg mt-2"> Go to the <a href="newStudents.html" class ="hover:underline hover:text-green-500"><strong > unassigned students</strong></a> section to select students! </div>
